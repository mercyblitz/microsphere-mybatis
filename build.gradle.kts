        ...
        publications {
            create<MavenPublication>(mavenTaskName) {
                ...
                pom {
                    ...
                    scm {
                        url = "git@github.com/microsphere-projects/microsphere-mybatis.git"
                        connection = "scm:git:git@github.com/microsphere-projects/microsphere-mybatis.git"
                        developerConnection =
                            "scm:git:ssh://git@github.com/microsphere-projects/microsphere-mybatis.git"
                    }

                    issueManagement {
                        system = "GitHub"
                        url = "https://github.com/microsphere-projects/microsphere-mybatis/issues"
                    }
                }
